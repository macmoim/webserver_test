...
public class TintHelper {
    public static void SetTint(RadioButton radioButton, int color) {
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                Utils.ResolveColor(radioButton.getContext(), R.attr.colorControlNormal),
                color
        });
    ...
    private static ColorStateList createEditTextColorStateList(Context context, int color) {
        ...
        colors[i] = Utils.ResolveColor(context, R.attr.colorControlNormal);
        i++;
    ...
    public static void SetTint(CheckBox box, int color) {
        ColorStateList sl = new ColorStateList(new int[][]{
                ...
                Utils.ResolveColor(box.getContext(), R.attr.colorControlNormal),
                color
        });
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
