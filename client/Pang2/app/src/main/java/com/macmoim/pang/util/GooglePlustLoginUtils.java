...
public class GooglePlustLoginUtils implements ConnectionCallbacks, OnConnectionFailedListener, OnClickListener {
    ...
    public GooglePlustLoginUtils(Context ctx, int btnRes) {
